...
// @author rpulkka
/**
 * A class for handling the Full House combination scoring. It is separated from
 * XOfAKind because Full House functions a little bit differently as it needs
 * two different sizes of instance lists. In detail, another difference is that
 * the number of instances needed for a Full House is exact, and the others can
 * use a function that counts instances higher than x.
 */
